...
if ( function_exists( 'register_nav_menus' ) ) {
	register_nav_menus(
		array(
		  ...
		  'secondary_nav' => 'Secondary Navigation Menu <br /> <small>Will only display if applicable header layout is selected <a href="'. admin_url('?page=redux_options&tab=3') .'">here</a>.</small>'
		)
	);
}	
		    ...
		    <div class="row page-header-no-bg">
		    	<div class="container">	
					<div class="col span_12 section-title">
						...
						if( $page_template == 'page-portfolio.php' && $display_sortable == '1') { ?>
						<div id="portfolio-filters">
							<a href="#" data-sortable-label="<?php echo (!empty($options['portfolio-sortable-text'])) ? $options['portfolio-sortable-text'] : __('Sort Portfolio', NECTAR_THEME_NAME); ?>" id="sort-portfolio"><span><?php echo (!empty($options['portfolio-sortable-text'])) ? $options['portfolio-sortable-text'] : __('Sort Portfolio',NECTAR_THEME_NAME); ?></span> <i class="icon-angle-down"></i></a>
							<ul>
							   <li><a href="#" data-filter="*"><?php echo __('All', NECTAR_THEME_NAME); ?></a></li>
			               	   <?php wp_list_categories(array('title_li' => '', 'taxonomy' => 'project-type', 'show_option_none'   => '', 'walker' => new Walker_Portfolio_Filter())); ?>
							</ul>
