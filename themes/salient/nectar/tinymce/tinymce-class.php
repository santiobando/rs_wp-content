...
# Add button to page
#-----------------------------------------------------------------
add_action('media_buttons_context','nectar_buttons');

function nectar_buttons($context) {
     return $context.="<a data-effect='mfp-zoom-in' class='button nectar-shortcode-generator' href='#nectar-sc-generator'><img src='".get_template_directory_uri()."/nectar/assets/img/icons/n.png' /> Nectar Shortcodes</a>";
}
