	...
	$sections[] = array(
        ...
        'fields' => array( 
			...
			array(
                ...
                'type' => 'select', 
                'title' => __('Nectar/Home Slider Caption & Testinomial', NECTAR_THEME_NAME),
                'desc' => '',
                'options' => $typography_mixed_fonts
			),
        ...
        'fields' => array( 
			...
			array(
			 ...
			 array(
                ...
                'type' => 'checkbox',
                'title' => __('Disable AJAX search', NECTAR_THEME_NAME), 
                'sub_desc' => __('Do you want to turn off the AJAX search function?', NECTAR_THEME_NAME),
                'desc' => '',
                'std' => '0' 
            ),
            array(
