...
function nectar_custom_css() {
	...
	$nav_font_size = (!empty($options['use-custom-fonts']) && $options['use-custom-fonts'] == 1 && !empty($options['navigation_font_size'])) ? intval(substr($options['navigation_font_size'],0,-2) -1 ) : 20;
