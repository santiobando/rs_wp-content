...
function nectar_typography() { 
	...
	{'; ?>	
		<?php if($options['nectar_slider_heading_font'] != '-') echo 'font-family:' . $options['nectar_slider_heading_font'].';'; ?>
	...
	<?php echo '#featured article .post-title h2 span, blockquote, .swiper-slide .content p, .testimonial_slider blockquote, .testimonial_slider blockquote span
	{'; ?>	
